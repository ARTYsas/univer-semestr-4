...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\artem\Documents\python\структуры данных\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\artem\Documents\python\структуры данных\venv\Scripts\deactivate.nu'
